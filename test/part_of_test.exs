defmodule PartOfTest do
  ...
  packet "Packet", id: :packet do
    field("id", 2, doc: "id")
    field("type-specific field", 14, id: :type_specific_field, doc: "type-specific field")
    field("payload", 8, doc: "the rest")
  end

  packet "Type 0", id: :type_0, of: :packet do
    field("id", 2, fixed: 0, doc: "id")
    field("first field", 4, part_of: :type_specific_field, doc: "type-specific field 0")
    field("second field", 10, part_of: :type_specific_field, doc: "type-specific field 1")
  end

  packet "Type 1", id: :type_1, of: :packet do
    field("id", 2, fixed: 3, doc: "id")
    field("different first field", 9, part_of: :type_specific_field, doc: "type-specific field 0")
    field("different second field", 5, part_of: :type_specific_field, doc: "type-specific field 1")
  end
